...
if (isset($_GET['aceptar']) == "Aceptar y continuar") {
    $slid = $slider->eliminarSlider($ide);
            ...
            <div style="padding: 15px; margin: 0px auto 0px auto; width: 100%" id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12 text-center">
                        ...
                        <h3>Imagen:</h3><br><img src="../<?php echo $slid["imagen"] ?> "width="200"><hr>
                        <form method="GET" action="eliminarSlider.php?id=<?php echo $ide ?>" enctype="multipart/form-data">
                            <h3>Nombre:</h3><p><?php echo $slid["titulo"] ?></p><hr>
                            <h3>Descripción:</h3><p><?php echo $slid["informacion"] ?></p><hr>
                            <input type="hidden" name="id" value="<?php echo $ide ?>"><br>
                            <input type="submit" name="aceptar" value="Aceptar y continuar" class="btn btn-outline-danger"><br><br>
