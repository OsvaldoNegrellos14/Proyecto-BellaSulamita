...
if (isset($_GET['aceptar']) == "Aceptar y continuar") {
    $categoria->eliminarCategoria($ide);
            ...
            <div style="padding: 15px; margin: 0px auto 0px auto; width: 100%" id="content">
                ...
                <div class="container-fluid">
                    <div class="col-md-12 text-center">
                        <br><h1>¿Seguro que desea eliminar la foto?</h1>
                        <h5>Esta accion no se puede desahacer posteriormente.</h5>
                        <p style="color: red">Antes de eliminar una categoria asegurese que no exista un producto relacionado con esta.</p><hr>
