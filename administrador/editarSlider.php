...
if (isset($_POST["id"]) && isset($_POST["titulo"]) && isset($_POST["informacion"])) {
    if(!empty($_FILES["imagen"]["tmp_name"])){
        ...
        $resultado = $slider->editarSlider($_POST["id"], $imagen, $_POST["titulo"], $_POST["informacion"]);
    } else {
        $resultado = $slider->editarSlider($_POST["id"], $_POST["multimedia"], $_POST["titulo"], $_POST["informacion"]);
    }
            ...
            <div style="padding: 15px; margin: 0px auto 0px auto; width: 100%" id="content">
                ...
                <div class="container-fluid">
                    <form action="editarSlider.php?id=<?php echo $ide ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <p style="margin-bottom: 5px;">Información:</p>
                        <div class="input-group mb-3">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <img src="../<?php echo $slid["imagen"] ?>"  width="auto" height="150px"><br>
                                <input type="hidden" name="id" value="<?php echo $ide ?>">
                                <input type="hidden" name="multimedia" value="<?php echo $slid["imagen"]?>">
                            </div>
                            <div style="margin-top: 30px" class="col-lg-6 col-sm-12">
                                ...
                                <button style="width: 100px" type="button" class="btn btn-outline-secondary"><a href="tablaSlider.php" style="text-decoration: none">Salir</a></button>
                            </div>
                        </div>
                        <?php 
                        if(!empty($resultado)){
